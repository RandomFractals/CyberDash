...
Rate and RT bot log trace from the first 9 hours of day 1 that bot going live:

![Alt text](https://github.com/RandomFractals/CyberDash/blob/master/screens/WebPackSenseHealthy9hrsBotRunDay1.png?raw=true 
 "@WebPackSense")
